            ...
            >
                <Stack spacing={2}>
                    ...
                    <Typography variant="h4">
                        ...
                        Giá sách:  <span style={{ color: 'red' }}>{fCurrency(price)}</span>
                    </Typography>
                    <Typography variant="h6">
                        {priceSale && (
                            <Box
                                ...
                                sx={{ color: 'text.disabled', textDecoration: 'line-through', mr: 0.5 }}
                            >
                                Giá thuê {fCurrency(priceSale)}
                            </Box>
                        )}

                        Giá thuê: {fCurrency(price)}
                    </Typography>
                </Stack>
                <Typography variant="subtitle2">Tác giả/ Dịch giả</Typography>
                <Typography variant="subtitle2">Loại bìa</Typography>
